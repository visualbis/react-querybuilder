...
const renderFieldSelector = ({ controls, translations, classNames, fields, level, field, operator, onFieldChanged }) => {
    return (
...
const renderOperatorSelector = ({ controls, translations, classNames, fieldData, level, field, getOperatorsList, operator, onOperatorChanged }) => {
    return (
