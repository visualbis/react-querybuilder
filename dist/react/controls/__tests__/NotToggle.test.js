...
describe('<NotToggle />', function () {
  ...
  describe('when using default rendering', function () {
    it('should have a <label /> element', function () {
      var dom = (0, _enzyme.shallow)( /*#__PURE__*/_react.default.createElement(_.NotToggle, props));
    ...
    it('should have the value passed into the <input />', function () {
      var dom = (0, _enzyme.shallow)( /*#__PURE__*/_react.default.createElement(_.NotToggle, _extends({}, props, {
        checked: true
      })));
