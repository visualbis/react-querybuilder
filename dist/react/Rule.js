...
var renderRemoveRuleAction = function renderRemoveRuleAction(_ref) {
  var controls = _ref.controls,
    ...
    level = _ref.level;
  return /*#__PURE__*/_react.default.createElement(controls.removeRuleAction, {
...
var renderValueEditor = function renderValueEditor(_ref2) {
  ...
  return /*#__PURE__*/_react.default.createElement(controls.valueEditor, {
    field: field,
    fieldData: fieldData,
...
var renderFieldSelector = function renderFieldSelector(_ref3) {
  ...
  return /*#__PURE__*/_react.default.createElement(controls.fieldSelector, {
    options: fields,
...
var renderParentOperatorSelector = function renderParentOperatorSelector(_ref4) {
  ...
  return /*#__PURE__*/_react.default.createElement(controls.parentOperatorSelector, {
    field: field,
    fieldData: fieldData,
...
var renderOperatorSelector = function renderOperatorSelector(_ref5) {
  ...
  return /*#__PURE__*/_react.default.createElement(controls.operatorSelector, {
    field: field,
    fieldData: fieldData,
    title: translations.operators.title,
    placeHolderTooltip: true,
