...
describe('<ValueEditor />', function () {
  ...
  describe('when using default rendering', function () {
    it('should have an <input /> element', function () {
      var dom = (0, _enzyme.shallow)( /*#__PURE__*/_preactCompat.default.createElement(_.ValueEditor, props));
      (0, _chai.expect)(dom.find('input')).to.have.length(1);
    });
    it('should have the value passed into the <input />', function () {
      var dom = (0, _enzyme.shallow)( /*#__PURE__*/_preactCompat.default.createElement(_.ValueEditor, _extends({}, props, {
        value: "test"
      })));
  ...
  describe('when rendering a select', function () {
    it('should render the correct number of options', function () {
      var wrapper = (0, _enzyme.mount)( /*#__PURE__*/_preactCompat.default.createElement(_.ValueEditor, _extends({}, props, {
        type: "select",
        values: [{
          name: 'test',
          label: 'Test'
